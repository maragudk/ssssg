...
func layoutsDefaultHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "layouts/default.html", size: 356, mode: os.FileMode(0644), modTime: time.Unix(1598365645, 0)}
...
func pagesIndexHtml() (*asset, error) {
	...
	info := bindataFileInfo{name: "pages/index.html", size: 272, mode: os.FileMode(0644), modTime: time.Unix(1598365645, 0)}
